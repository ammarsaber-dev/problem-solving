...
@Suite struct WindowingSystemTests {
    ...
    func testMainWindow() {
        let window = Window(
            title: "Main Window", contents: "This is the main window",
            size: Size(width: 400, height: 300), position: Position(x: 100, y: 100))
        #expect(
            window.display()
    ...
    func testMainWindowNoContents() {
        let window = Window(
            title: "Main Window", contents: nil, size: Size(width: 400, height: 300),
    ...
    func testMainWindowNoSize() {
        let window = Window(
            title: "Main Window", contents: "This is the main window", size: Size(),
            position: Position(x: 100, y: 100))
        #expect(
            window.display()
    ...
    func testMainWindowNoPosition() {
        let window = Window(
            title: "Main Window", contents: "This is the main window",
            size: Size(width: 400, height: 300), position: Position())
        #expect(
            window.display()
