...
@Suite struct MasterMixologistTests {
    func checkTest(e: DrinkTrack, g: DrinkTrack) -> Bool {
        ...
        return expected.first == got.first && expected.last == got.last
    ...
    let orders = [
        ...
        ["mixed drink", "water", "soda", "soda", "beer"],
        Array(repeating: "frozen drink", count: 10),
    ]
    ...
    func testMakeWedgesNoLimes() {
        ...
        #expect(
            0 == got, "You have no limes to cut up so you used 0 limes; you said you used \(got).")
    }
