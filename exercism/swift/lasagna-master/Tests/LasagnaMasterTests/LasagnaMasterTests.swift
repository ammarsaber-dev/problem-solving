...
@Suite struct LasagnaMasterTests {
    ...
    func testToOz() {
        var amount = quantities(
            layers: "sauce", "noodles", "béchamel", "meat", "sauce", "noodles", "sauce",
            "mozzarella")
        toOz(&amount)
    ...
    func testRedWineRedEqualLayerCount() {
        #expect(
            redWine(
                layers: "sauce", "noodles", "ricotta", "sauce", "noodles", "béchamel", "meat",
                "noodles",
                "mozzarella"))
    }
    ...
    func testRedWineWhite() {
        #expect(
            !redWine(
                layers: "sauce", "noodles", "béchamel", "meat", "mozzarella", "noodles", "sauce",
                "ricotta",
